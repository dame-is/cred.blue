...
const Home = () => {
  ...
  return (
    ...
    <meta name="description" content="Generate a Bluesky credibility score. Understand your AT Proto data footprint. Vibe check strangers and new accounts." />
    
    {/* OpenGraph Meta Tags */}
    <meta property="og:title" content="cred.blue" />
    <meta property="og:description" content="Generate a Bluesky credibility score. Understand your AT Proto data footprint. Vibe check strangers and new accounts." />
    ...
    <meta name="twitter:description" content="Generate a Bluesky credibility score. Understand your AT Proto footprint. Vibe check strangers and new accounts." />
