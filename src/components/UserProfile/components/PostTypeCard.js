...
const PostTypeCard = () => {
  ...
  return (
    ...
    <p>
       <strong>Replies:</strong> {(accountData.activityAll.postStats.replyPercentage * 100).toFixed(2)}%
    </p>
    <p>
       <strong>Quotes:</strong> {(accountData.activityAll.postStats.quotePercentage * 100).toFixed(2)}%
    </p>
    </>
  );
};
